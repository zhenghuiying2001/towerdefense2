...
void thirdwindow::updatePosition()
{
    //更新地图的坐标
    m_map.mapPosition();
...
void thirdwindow::enemyToScene()
{
    ...
    for(int i=0;i<ENEMY_NUM;i++)
    {
        ...
        if(m_enemys[i].m_Free)
        {
            ...
            //坐标
            m_enemys[i].m_X=rand()%(800-m_enemys[i].m_Rect.width());
...
void thirdwindow::collisionDetection()
{
    //遍历所有非空闲的敌机
    for(int i=0;i<ENEMY_NUM;i++)
    {
